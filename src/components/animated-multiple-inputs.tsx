  ...
  ({ className, children }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          "z-10 flex size-12 items-center justify-center rounded-full border-2 border-indigo-700 bg-gray-800 p-3 text-indigo-300 shadow-[0_0_20px_-12px_rgba(99,102,241,0.5)]",
          className,
        )}
      >
        {children}
