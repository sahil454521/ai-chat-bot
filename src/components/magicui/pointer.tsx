...
export function Pointer({
  ...
  useEffect(() => {
    const handleMouseOver = (e: MouseEvent) => {
      ...
      if (cursorType === "input") {
        containerRef.current?.classList.add("cursor-input");
      } else if (cursorType === "button") {
        containerRef.current?.classList.add("cursor-button");
      } else {
        containerRef.current?.classList.remove("cursor-input", "cursor-button");
      }
    };
